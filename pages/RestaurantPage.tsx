...
const RestaurantPage: React.FC = () => {
  ...
  const restaurant = dataState.restaurants.find(r => r.id === parseInt(id || ''));
    ...
    <div>
      ...
      <div className="relative h-64 md:h-80">
        ...
        <div className="absolute inset-0 container mx-auto p-4 sm:p-6 lg:p-8 flex flex-col justify-end">
            ...
            <p className="text-lg text-slate-200 mt-2">{restaurant.cuisine}</p>
      ...
      <div className="container mx-auto p-4 sm:p-6 lg:p-8">
        <h2 className="text-3xl font-bold mb-8 text-slate-800 dark:text-white">قائمة الطعام</h2>
